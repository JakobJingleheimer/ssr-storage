...
var _a;
"use strict";
const camelCase_1 = __importDefault(require("../../node_modules/lodash/camelCase"));
const chunk_1 = __importDefault(require("../../node_modules/lodash/chunk"));
const map_1 = __importDefault(require("../../node_modules/lodash/map"));
...
class Document {
    ...
    get cookie() {
        ...
        return map_1.default(items, (item) => item.join('='))
            .join('; ');
    }
    ...
    set cookie(input) {
        ...
        const { expires, maxAge, } = chunk_1.default(pieces, 2)
            .reduce((metadata, [k, v]) => {
            metadata[camelCase_1.default(k.trim())] = v;
            return metadata;
        }, {});
        if (expires) {
